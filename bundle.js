...
var stepsReducer = function stepsReducer() {
  ...
  switch (action.type) {
    case _actions_step_actions__WEBPACK_IMPORTED_MODULE_0__.RECEIVE_STEPS:
      ...
      var nextStateSteps = {};
      Object.values(action.steps).forEach(function (step) {
...
/* harmony import */ var _frontend_actions_step_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../frontend/actions/step_actions */ "./frontend/actions/step_actions.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.removeTodo = _frontend_actions_todo_actions__WEBPACK_IMPORTED_MODULE_1__.removeTodo;
  window.receiveStep = _frontend_actions_step_actions__WEBPACK_IMPORTED_MODULE_2__.receiveStep;
  window.receiveSteps = _frontend_actions_step_actions__WEBPACK_IMPORTED_MODULE_2__.receiveSteps;
  window.removeStep = _frontend_actions_step_actions__WEBPACK_IMPORTED_MODULE_2__.removeStep;
});
})();
